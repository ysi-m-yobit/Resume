...
## 働きたい環境
- なるべく客先常駐ではなく自社での勤務
- テストコードやCIといった部分を常に意識でき、実際にそれらの成果を管理できている環境
...
## 職務経歴
### <u>■Webサイト開発プロジェクト（2019/6～2020/1)</u>
##### プロジェクト概要
医療従事者向けWebサイト構築
...
### <u>■2拠点間VPN接続環境構築（2019/5～2019/6)</u>
##### プロジェクト概要
2つの拠点間でのVPN接続環境構築
...
### <u>■Webサイトインフラ構築プロジェクト（Azure）（2019/4～2019/5)</u>
##### プロジェクト概要
...
##### コメント
他の担当によるAzureでのインフラ設計の考慮漏れやネットワーク設計の不備を修正するため、急遽プロジェクトに参画。  
App Service、Traffic Manager、Application Gatewayを利用した一般的なDR構成のものだが、Traffic ManagerとApplication Gatewayの利用方法に誤りがあったため、指摘して修正。  
...
その後はプロジェクトを納期に間に合わせるために、やらなくてはいけないことと順序を整理し、方針を提出することで役割を終了。

### <u>■Webサイト開発プロジェクト（2019/1～2019/4) </u>
##### プロジェクト概要
Webサイト構築
...
### <u>■Webサイト開発プロジェクト（2018/7～2019/1) </u>
##### プロジェクト概要
イントラネット向けWebサイト構築
...
### <u>■クラウド基盤プロジェクト（2017/1～2018/6) </u>
...
このプロジェクトで、DRやBCPといった災害対策についての重要性や、クラウドにおける可用性の実現方法、BGPやLAGなどのネットワーク部分の知見を得ることが出来た。

### <u>■Webアプリケーション開発プロジェクト（2013/3～2016/10) </u>
